                ...
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('viewJadwal') }}"
                            ...
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Input
                                Jadwal</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('periksaPasien') }}"
                            class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-pink-400">
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Periksa
                                Pasien</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('riwayatPeriksa') }}"
                            ...
                            <i class="fas fa-home fa-fw mr-3 text-blue-400"></i><span
                                class="pb-1 md:pb-0 text-sm">Riwayat Periksa</span>
                        </a>
                    </li>
            </div>
        </div>
